// js/sirkat.js - كود صفحة سركات (محدث بالكامل مع تصدير PDF في صفحة واحدة)
...
// ====== تصدير PDF (Portrait - صفحة واحدة مع تحكم كامل في الحجم) ======
function saveSirkatPDF() {
    ...
    // 🔥 تنسيق مباشر للجدول - تحكم كامل في الحجم
